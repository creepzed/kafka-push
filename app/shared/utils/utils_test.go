...
func Test_Unzip(t *testing.T) {
	t.Parallel()
	//t.Run("When receive a zip as []bytes should return and []bytes with uncompress data", func(t *testing.T) {
	//
	...
	//
	//	// uncompress data
	//	uncompressedData, uncompressedDataErr := Uncompress(compressedData)
	//	if uncompressedDataErr != nil {
	//		log.Fatal(uncompressedDataErr)
	//	}
	//
	//	assert.Equal(t, data, uncompressedData)
	//})
